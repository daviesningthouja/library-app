    ...
    <div className='product-wrapper'>
      <section className='product-hero-section'>
        ...
        <div className='product-hero'>
            ...
            <p>Our state-of-the-art Library Management System is designed to simplify and enhance every aspect of library operations. From cataloging books to managing users and tracking loans, our product offers a complete solution tailored to meet the needs of modern libraries.</p>
            </div>
        </div>
      </section>
